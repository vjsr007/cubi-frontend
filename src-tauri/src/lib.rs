...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pc_games::import_xbox_games,
            ...
            commands::catalog::check_rgsx_connection,
            commands::rgsx::rgsx_get_platforms,
            commands::rgsx::rgsx_get_games,
            commands::rgsx::rgsx_download_game,
            commands::rgsx::rgsx_get_progress,
            ...
            commands::emulator_commands::set_emulator_preference,
            ...
            commands::flash_mapping::get_flash_key_mappings,
            commands::flash_mapping::set_flash_key_mapping,
            commands::flash_mapping::delete_flash_key_mapping,
            commands::flash_mapping::reset_flash_key_mappings,
            commands::flash_mapping::get_default_flash_mappings,
            commands::flash_mapping::get_flash_button_label,
            commands::flash_mapping::get_flash_game_config,
            commands::flash_mapping::set_flash_game_config,
        ])
        .setup(|app| {
